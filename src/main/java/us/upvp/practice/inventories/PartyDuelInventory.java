...
public class PartyDuelInventory
{
    ...
    {
        final Inventory inventory = Bukkit.createInventory(null, 9, ChatColor.translateAlternateColorCodes('&', "&6Click to duel. &7(Party)"));
        ...
        inventory.setItem(6, getAxe());
        inventory.setItem(7, getNoEnchants());
        return inventory;
    }
}
