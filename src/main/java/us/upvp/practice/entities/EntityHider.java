package us.upvp.practice.entities;
...
{
    private Table<Integer, Integer, Boolean> observerEntityMap = HashBasedTable.create();
...
//                new PacketAdapter(API.getPlugin(), PacketType.Play.Client.)
//                {
//                    @Override
//                    public void onPacketSending(PacketEvent event)
//                    {
//                        Entity entity = event.getPacket().getEntityModifier(event).read(0);
//                        if(entity instanceof CraftThrownPotion)
//                        {
//                            System.out.println("pot");
//                            if(!isVisible(event.getPlayer(), entity.getEntityId()))
//                            {
//                                System.out.println("not visable");
//                                for(WrappedWatchableObject object : event.getPacket().getWatchableCollectionModifier().read(0))
//                                {
//                                    System.out.println("index " + object.getIndex() + " == " + object.getValue());
//                                    if(object.getIndex() == 7)
//                                    {
//                                        API.getLogger().log(Level.FINER, "potion index = 7 value = " + object.getValue());
//                                        object.setValue(0);
//                                    }
//                                    if(object.getIndex() == 8)
//                                    {
//                                        API.getLogger().log(Level.FINER, "potion index = 8 value = " + object.getValue());
//                                        object.setValue(0);
//                                    }
//                                }
//                            }
...
//                        else
//                        {
//                            System.out.println("not pot but " + entity.toString());
//                        }
//                    }
//                }
//        );
